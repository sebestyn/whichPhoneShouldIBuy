...
fonoapi.token = process.env.FONAPI_TOKEN;
var logedIn = false;
    ...
    if (data.length > 0) {
      data.forEach((telefon) => {
        ...
        try {
          ...
          let resolution =
            resolution_array[resolution_array.indexOf("pixels") - 3] +
            resolution_array[resolution_array.indexOf("pixels") - 2] +
            resolution_array[resolution_array.indexOf("pixels") - 1];
          if (!resolution) {
            resolution =
              resolution_array[resolution_array.indexOf("pixels,") - 3] +
              resolution_array[resolution_array.indexOf("pixels,") - 2] +
